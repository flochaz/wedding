      ...
      { 
        ...
        if (match_pos > -1) // if we found a match
        {
          ...
          n.parentNode.insertBefore(after, n.nextSibling); // insert after
                ...
                parentTextDiv = document.getElementById(highlight_span.id).offsetParent;
                var image = parentTextDiv.parentElement.getElementsByTagName('img')[0];
                image.style.opacity = 0;
                parentTextDiv.style.opacity = 1;
...
function findit() 
{
  ...
  else
  {
    ...
    {
      alert("Votre nom n'a pas était trouvé. Merci de Contacter Mélanie"); // ver 5.1 - 10/17/2014 - changed from "Not Found"
      find_pointer = -1;  
    }
  }
  findwindow.style.visibility = 'visible';
...
//      elemPosY < scrollTop || elemPosY > scrollBottom) 
    window.scrollTo(0 ,elemPosY - 100); 
  }
...
// This part creates the instructions and the "find" button
  findwindow.innerHTML += '<div id="window_body" style="padding: 1em;">'
  ...
  + '<input id="btn" type="button" value=">" onclick="this.blur(); findit();">' // ver 5.3 - 5/15/2015 - added this.blur();
...
//document.write('<input type="button" value="Chercher mon nom..." onclick="show();">');
